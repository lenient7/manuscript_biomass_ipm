...
#+BEAMER_HEADER: \title[Biomass Interparticle Mechanics]{Friction and adhesion between biomass particles}
...
#+EMAIL: huy1@psu.edu
#+LANGUAGE: English
#+DESCRIPTION: Manuscript on the friction and adhesion between biomass particles
...
Based on the observation that cob particles show a larger standard deviation in the coefficient of friction, it can be hypothesized that cob particles will contribute significantly to erratic feedstock flow behavior.
#+END_abstract
