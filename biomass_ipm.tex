...
\caption{\label{fig:orgcfddf21}Schematic of the emerging bulk mechanical properties from the mechanical interactions between biomass particles to the bulk mechanical behavior of milled biomass}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orgcf03b76}Physical properties of corn stover particles of different tissue type (Forest Concepts, LLC analytics laboratory in Auburn, WA). Values after \textpm{} represents standard error.}
\centering
...
To overcome such shortfalls, we developed a new Inter-particle Mechanics (IPM) (Figure \ref{fig:org49125db}) to measure the traction force between a stationary and moving particle under a varying magnitude of normal load.
...
\caption{\label{fig:org49125db}Inter-particle mechanics tester (right) with a detailed view of sample mounting (left).}
\end{figure}
\subsection{Specifications and Operational Parameters of Interparticle Mechanics Tester}
\label{sec:orge56a168}
...
\begin{table}[htbp]
\caption{\label{tab:org9306ffb}Experimental plan for the required number of corn fraction test pairs and associated repetitions.}
\centering
\begin{tabular}{ccc}
\hline
...
Table \ref{org54557c5} lists the results of the validation experiment.
...
\begin{table}
  ...
  \end{longtable}
  \endgroup
\caption{\label{org54557c5}Validation test results of polypropylene}
\end{table}

\begin{figure}[htbp]
\centering
\includegraphics[height=4in]{./figures/pp_pp_comb_ipm_coeffs_box_plts.png}
\caption{\label{fig:org5aef3b8}Interparticle Mechanics Test results of polypropylene sheet samples. Each color represents a different run of the experiments (n=20)}
\end{figure}

\newpage
\subsection{Typical corn stover particles IPM results}
\label{sec:orgb9add37}
\begin{figure}[!htb]
\centering
\includegraphics[width=.9\linewidth]{./figures/typical_result_cs_two_cases.png}
\caption{\label{fig:orgd5c4e18}Typical corn stover particle result (A is from cob particle vs. cob particle and B is from cob particle vs stalk particle)}
\end{figure}


To examine the variability in frictional contact mechanics between corn stover particles from different tissue types, corn stover samples were manually fractionated into the cob, husk, leaf, and stalk, then crumbled using a 4 mm screen using Crumbler\textsuperscript{\textregistered} by Forest Concepts, LLC. Twenty particle sample pairs for each tissue type were prepared, and the interparticle mechanics tests were conducted. A typical experimental data and regression analysis result is shown in Figure \ref{fig:orgd5c4e18}. \marginnote{may want to use different result for dt\_ad\_cs typical\_stalk\_stalk 20230505\_11 plt}
It is notable that normal force approaches to zero value when compared to the polypropylene validation test (Figure \ref{fig:orgd5c4e18}).
...
\label{sec:orgef780ea}
\begin{figure}[htbp]
\centering
\includegraphics[height=4in]{./figures/cs_cs_same_fraction_coeff_mu_box_plt.png}
\caption{\label{fig:orgd86d323}Friction coefficient between corn stover particles of same tissue type}
\end{figure}
...
\caption{\label{fig:orgebc7d40}Adhesion force between corn stover particles of same tissue type}
\end{figure}
...
\label{sec:orgec56c1a}

\begin{figure}[htbp]
\centering
\includegraphics[height=4in]{./figures/cs_cs_different_fraction_coeff_mu_box_plt.png}
\caption{\label{fig:org2440e33}Friction coefficient between corn stover particles of different tissue type}
\end{figure}
...
\caption{\label{fig:org90cda40}Adhesion force between corn stover particles of different tissue types}
\end{figure}
...
Corn stover interactions involving cob fractions were found to contain the largest peaks and variance in friction coefficients (Table \ref{tab:orgceb3542}).
Cob particles with woody-ring sub-fractions on the contacting surface were observed to be significantly harder and 'claw-like' in nature.
...
\begin{table}[htbp]
\caption{\label{tab:orgceb3542}Wilcox Signed Rank Test Critical Values Table}
\centering
\begin{tabular}{ccc}
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org53c57a9}Anova test result}
\centering
\begin{tabular}{cccc}
\hline
...
\label{sec:orgda578f4}
\begin{itemize}
\item Abstract
\label{sec:org00a1601}
...
\label{sec:org25a298e}

---
\item Discussion
\label{sec:orgbec5c83}
...
\label{sec:org8172cbc}
Using DEM in biomass flow studies
\section{Acknowledgment}
\label{sec:org9f53369}
