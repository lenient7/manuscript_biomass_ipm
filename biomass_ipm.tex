...
\caption{\label{fig:orgf08ba99}Schematic of the emerging bulk mechanical properties from the mechanical interactions between biomass particles to the bulk mechanical behavior of milled biomass}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org46dc496}Physical properties of corn stover particles of different tissue type (Forest Concepts, LLC analytics laboratory in Auburn, WA). Values after \textpm{} represents standard error.}
\centering
...
To overcome such shortfalls, we developed a new Inter-particle Mechanics (IPM) (Figure \ref{fig:orgb991f36}) to measure the traction force between a stationary and moving particle under a varying magnitude of normal load.
...
\caption{\label{fig:orgb991f36}Inter-particle mechanics tester (right) with a detailed view of sample mounting (left).}
\end{figure}
\subsection{Specifications and Operational Parameters of Interparticle Mechanics Tester}
\label{sec:org9ad070d}
...
\begin{table}[htbp]
\caption{\label{tab:orgdbb0782}Experimental plan for the required number of corn fraction test pairs and associated repetitions.}
\centering
\begin{tabular}{ccc}
\hline
...
Table \ref{orgf24feae} lists the results of the validation experiment.
...
\begin{table}
  ...
  \end{longtable}
  \endgroup
\caption{\label{orgf24feae}Validation test results of polypropylene}
\end{table}

\begin{figure}[htbp]
\centering
\includegraphics[height=4in]{./figures/pp_pp_comb_ipm_coeffs_box_plts.png}
\caption{\label{fig:orgaf4a0ae}Interparticle Mechanics Test results of polypropylene sheet samples. Each color represents a different run of the experiments (n=20)}
\end{figure}
...
Corn stover interactions involving cob fractions were found to contain the largest peaks and variance in friction coefficients (Table \ref{tab:org68a1880}).
Cob particles with woody-ring sub-fractions on the contacting surface were observed to be significantly harder and 'claw-like' in nature.
...
\begin{table}[htbp]
\caption{\label{tab:org68a1880}Wilcox Signed Rank Test Critical Values Table}
\centering
\begin{tabular}{ccc}
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org20a6758}Anova test result}
\centering
\begin{tabular}{cccc}
\hline
...
\label{sec:orgb04b80e}
\begin{itemize}
\item Abstract
\label{sec:org97855ac}
...
\label{sec:org2442d15}

---
\item Discussion
\label{sec:orgdfd5724}
...
\label{sec:orgf23ba1c}
Using DEM in biomass flow studies
\section{Acknowledgment}
\label{sec:org819553f}
