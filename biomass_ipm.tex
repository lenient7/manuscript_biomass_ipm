...
\hypersetup{
 pdfauthor={James C. Slosson, Yiming Li, Sena Atsyo, Heather Burkholder, and Hojae Yi Elicit Review},
 pdftitle={Angle of internal friction and inter-particle friction coefficient Friction and Adhesion in Milled Corn Stover},
...
\caption{\label{fig:orgfb17f73}Schematic of the emerging bulk mechanical properties from the mechanical interactions between biomass particles to the bulk mechanical behavior of milled biomass}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org7e959c2}Physical properties of corn stover particles of different tissue type (Forest Concepts, LLC analytics laboratory in Auburn, WA). Values after \textpm{} represents standard error.}
\centering
...
To overcome such shortfalls, we developed a new Inter-particle Mechanics (IPM) (Figure \ref{fig:org672633e}) to measure the traction force between a stationary and moving particle under a varying magnitude of normal load.
...
\caption{\label{fig:org672633e}Inter-particle mechanics tester (right) with a detailed view of sample mounting (left).}
\end{figure}
\subsection{Specifications and Operational Parameters of Interparticle Mechanics Tester}
\label{sec:org400381f}
...
\begin{table}[htbp]
\caption{\label{tab:orgdd31691}Experimental plan for the required number of corn fraction test pairs and associated repetitions.}
\centering
\begin{tabular}{ccc}
\hline
...
Corn stover interactions involving cob fractions were found to contain the largest peaks and variance in friction coefficients (Table \ref{tab:org6013591}).
Cob particles with woody-ring sub-fractions on the contacting surface were observed to be significantly harder and 'claw-like' in nature.
...
\begin{table}[htbp]
\caption{\label{tab:org6013591}Wilcox Signed Rank Test Critical Values Table}
\centering
\begin{tabular}{ccc}
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org7687395}Anova test result}
\centering
\begin{tabular}{cccc}
\hline
...
\label{sec:org60a510e}
\begin{itemize}
\item Abstract
\label{sec:org7061367}
...
\label{sec:org9fd2635}

---
\item Discussion
\label{sec:org988c1ef}
...
\label{sec:org43ee03f}
Using DEM in biomass flow studies
\section{Acknowledgment}
\label{sec:org0de2626}
